let handler = async (m, { conn }) => {
  ...
  if (typeof werewolf.status != "undefined" && werewolf.status == "playing") {
    conn.reply(m.chat, "_Permainan Werewolf sudah berlangsung !!_", m)
    return
  }
  ...
  conn.reply(m.chat, "Permainan Werewolf dimulai. Silakan kirim '.wwjoin' untuk bergabung dalam permainan !", m)
}
handler.help = ['ww']
handler.tags = ['game']
