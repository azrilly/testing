...
handler.all = async function (m) {
	...
	let pp = 'https://files.catbox.moe/seg5yv.jpg'
	try {
		...
		global.pic = 'https://files.catbox.moe/17jbqv.jpg'
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: {
					...
					mediaUrl: sgc,
					description: 'Lala BOT - MD', 
					previewType: "PHOTO",
					thumbnail: await (await fetch(pic)).buffer(),
					sourceUrl: 'https://www.instagram.com/yanz_5008/profilecard/?igsh=Y2ZlOHF0dzlhMzJt'			
				}
			}
		}
                global.flocation = {
...
global.fakefb = {
         contextInfo: { externalAdReply: { showAdAttribution: true,
            ...
            mediaType: "VIDEO",
            description: "https://www.facebook.com/ryan.bodong.39?mibextid=ZbWKwL", 
            title: wm3,
            body: wm,
            thumbnailUrl: pp,
            sourceUrl: sgc
        ...
        global.fvn = {
            ...
            { remoteJid: "6285752235008-1625305606@g.us" } : {}) 
                       },
            message: { 
               "audioMessage": {
       ...
       key: {
           ...
           "message": {
               "groupInviteMessage": {
                   "groupJid": "6285752235008-1625305606@g.us",
                   "inviteCode": "null",
                   "groupName": "Kawan lala", 
                   "caption": wm, 
                   'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')
               }
           }
