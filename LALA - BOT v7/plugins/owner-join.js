...
*${conn.user.name}* adalah salah satu bot WhatsApp multi-perangkat yang dibuat dengan Node.js,
*${conn.user.name}* Baru diundang oleh owner *${m.name}*

Untuk melihat menu bot ketik  *${usedPrefix}help*
...
function msToDate(ms) {
  ...
  return [d, ' Hari '].map(v => v.toString().padStart(2, 0)).join('')
}
