...
conn.sendFile(m.chat, json.data[0].images.jpg.image_url, 'manga.jpg', `*MANGA INFO*\n` + animeingfo, m)
    conn.reply(m.chat, 'JANGAN LUPA FOLLOW DEVELOPER BOT\nZENN\nhttps://www.instagram.com/yanz_5008/profilecard/?igsh=Y2ZlOHF0dzlhMzJt', m)
}
handler.help = ['infomanga <NamaManga/Anime>']
handler.tags = ['anime']
