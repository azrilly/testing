...
await conn.sendMessage(m.chat, {text: loadd[i], edit: key })}
  ...
  let mentionedJid = [m.sender]
    ...
    let sts = ` – *Info LalaBot MD*
    
┌ ◦ ᴀᴋᴛɪғ sᴇʟᴀᴍᴀ ${uptime}
│ ◦ *1${groups.length}* ɢʀᴜᴘ
...
await conn.sendMessage(m.chat, {
	        video: fs.readFileSync('./src/mp4/infobot.mp4'),
            mimetype: 'video/mp4',
            fileLength: 100000,
            caption: sts,
            gifPlayback: true,
            ...
            contextInfo: {
                externalAdReply: {
                    ...
                    title: 'Lala Bot - MD 🎌',
                    thumbnailUrl: 'https://files.catbox.moe/7qoc7m.jpg',
                    sourceUrl: 'https://www.instagram.com/p/CLPWKRYgkEW/?igsh=MW9xa2xjZTBjNWlxdw==',
                    mediaType: 1,
                    renderLargerThumbnail: true,
                    mentionedJid: [m.sender]
	}}}, { quoted: m,ephemeralExpiration: 86400});
	let anjay = fs.readFileSync('./src/mp3/infobot.mp3')
...
seconds: 18,
fileLength: 18,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'Lala Bot - MD 🎌', body: wm, sourceUrl: 'https://Wa.me/+62857-5223-5008?text=hai👋🏻', thumbnail: await (await fetch(thumb)).buffer(),}}  
  }) 
}
