...
const defaultMenu = {
  before: `Hi %name.\nMy name is ${global.info.namebot}. Aku Akan Buat Kalian Sagne 😘
...
`.trimStart(),
  ...
  body: '*│ •* %cmd',
  footer: '*└* ',
  after: 'SAGNE BOT BY FERNAZER CODE',
}
...
conn.sendMessage(m.chat, {
            ...
            contextInfo: {
                ...
                isForwarded: true,
                   ...
                   body: 'Powered By Fernazer Code',
                   thumbnailUrl: global.maximus ? global.maximus : thum,
                   sourceUrl: pickRandom(["https://chat.whatsapp.com/","https://chat.whatsapp.com/"]),
                   mediaType: 1,
